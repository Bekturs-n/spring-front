  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p v-if="showError" class="text-sm font-light text-gray-500 dark:text-gray-400" style="color: crimson;">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href="/registration" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
...
export default {
    ...
    methods: {
        logIn() {
            this.CheckError();
            this.formData = '{"email":"' + document.getElementById('email').value + '", "password":"' + document.getElementById('password').value + '"}';
        ...
        CheckError(){
            if (localStorage.getItem('authError') === null) {
                localStorage.setItem('authError', null);
                this.showError = true;
            } else {
